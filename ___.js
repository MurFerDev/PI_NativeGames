...
// npm run devconst db = require('./database/db.js'); // Importa o módulo de conexão com o banco de dados
...
app.use('/static', express.static(path.join(__dirname + '/static'))); // Pasta para arquivos estáticos
...
app.use(session({
  secret: '$3nac@Native_Games',
  resave: false,
  saveUninitialized: false,
  cookie: { maxAge: 7200000 } // 2 horas de sessão
}));

app.use('/api/usuarios', require('./routes/usuarioRoutes'));
app.use('/api/jogos', require('./routes/jogoRoutes'));
